...
d.addEventListener("DOMContentLoaded", function () {
  function getPosts() {
    fetch("../procesarInformacion/portfolios/obtener-portafolios.php", {
      method: "POST",
      body: JSON.stringify({
        action: "selectPortafolio",
      }),
    })
...
export async function getAllPortafolio() {
  try {
    let res = await fetch("crud_portafolio/rest-portafolio.php", {
      method: "GET",
    });
...
function representData(portafolio) {
  ...
  deleteIcon.addEventListener("click", function () {
    ...
    d.getElementById("deleteModal").modal("show");
    // Configurar el botón de confirmar borrado
    d.getElementById("confirmDeleteBtn").addEventListener("click", function () {
      ...
      //  CAMBIAR
      d.getElementById("confirmModal").modal("hide");
    });
  });
